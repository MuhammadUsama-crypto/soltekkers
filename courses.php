    ...
    <header class="py-8 py-lg-12 mb-8 overlay overlay-primary overlay-80" style="background-image: url(assets/img/covers/cover-19.jpg);">
        <div class="container text-center py-xl-5">
            <h1 class="display-4 fw-semi-bold mb-0 text-white">Our Courses</h1>
                ...
                <div class="mb-4 mb-xl-0 ms-xl-6">
                    ...
                    <form class="">
                        <div class="input-group input-group-filter">
                            <input class="form-control form-control-sm placeholder-dark border-end-0" type="search" placeholder="Search our courses" aria-label="Search">
    ...
    <div class="container pb-4 pb-xl-7">
        ...
        <div class="text-center mb-7">
            <a class="btn btn-outline-white mw-300p d-flex mx-auto read-more" data-toggle="collapse" href="#loadcollapseExample" role="button" aria-expanded="false" aria-controls="loadcollapseExample">
