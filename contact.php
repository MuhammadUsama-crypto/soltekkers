<?php  
    ...
    <div class="container">
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <address class="">
                                Backside of Boulevard Mall Saeed Colony no. 1, Faisalabad, Pakistan.
                                </address>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <a href="tel:3159052321" class="text-gray-800 d-block">+92-325-0096-666</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <p class="mb-0">Mon-Sat: 10am to 6pm</p>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <a href="mailto:soltekkers@gmail.com" class="text-gray-800">soltekkers@gmail.com</a>
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <ul class="list-unstyled list-inline list-social mb-4 mb-md-0 mx-n4">
                                    <li class="list-inline-item list-social-item">
                                        <a href="https://www.facebook.com/profile.php?id=61550037057480" class="text-secondary font-size-sm w-36 h-36 shadow-dark-hover d-flex align-items-center justify-content-center rounded-circle border-hover">
                                            <i class="fab fa-facebook-f"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item list-social-item">
                                        <a href="https://twitter.com/SolTekkers" class="text-secondary font-size-sm w-36 h-36 shadow-dark-hover d-flex align-items-center justify-content-center rounded-circle border-hover">
                                            <i class="fab fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item list-social-item">
                                        <a href="https://www.instagram.com/soltekkers/" class="text-secondary font-size-sm w-36 h-36 shadow-dark-hover d-flex align-items-center justify-content-center rounded-circle border-hover">
                                            <i class="fab fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li class="list-inline-item list-social-item">
                                        <a href="https://www.linkedin.com/company/96882838/admin/feed/posts/" class="text-secondary font-size-sm w-36 h-36 shadow-dark-hover d-flex align-items-center justify-content-center rounded-circle border-hover">
            ...
            <div class="col-md">
                ...
                <form action="contact.php" method="post" class="row">
                    <div class="form-group mb-6 col-xl-6">
                        ...
                        <input type="text" name="name" class="form-control placeholder-1" id="exampleInputTitle1" placeholder="">
                    </div>

                    <div class="form-group mb-6 col-xl-6">
                        <label for="exampleInputTitle2">Email</label>
                        <input type="email" name="email" class="form-control placeholder-1" id="exampleInputTitle2" placeholder="">
                    </div>
                    <div class="form-group mb-6 col-xl-12">
                        <label for="exampleInputTitle2">Suject</label>
                        <input type="text" name="subject" class="form-control placeholder-1" id="exampleInputTitle2" placeholder="">
                    </div>

                    <div class="form-group mb-6 col-12">
                        <label for="exampleFormControlTextarea1">Message</label>
                        <textarea class="form-control placeholder-1" name="message" id="exampleFormControlTextarea1" rows="6" placeholder="Content"></textarea>
                    </div>
        ...
        <div class="mb-8 mb-md-11 rounded overflow-hidden grayscal-hover">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3404.412208361914!2d73.11907407286114!3d31.430316994708306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x392269442ba28583%3A0x9907d591dc28fe35!2sEPSCC-Elite%20Physio%20and%20Special%20Children%20Center!5e0!3m2!1sen!2sus!4v1701429527052!5m2!1sen!2sus"width="1200" height="550" style="border:0;width: 100%;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
