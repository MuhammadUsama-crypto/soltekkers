<?php  
    ...
    <!-- COURSE
    ================================================== -->
    <div class="bg-primary pb-9 pt-8 pt-md-11">
        <div class="container">
            <div class="row">
                <?php 
...
$sql = "SELECT * FROM `course` WHERE `id`='$id'";
            ...
            while ($row = mysqli_fetch_assoc($result)){
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 position-relative">
                    ...
                    <div class="d-md-flex align-items-center mb-6">
                        <div class="border rounded-circle d-inline-block mb-4 mb-md-0 bg-white">
                            <div class="p-2">
                                <img src="assets/img/uploadedImages/<?php echo $row2['img']; ?>" alt="..." class="rounded-circle img-fluid" width="68" height="68">
                            </div>
                        </div>

                        <div class="ms-md-6">
                            <div class="mb-2 d-flex align-items-center">
                                <h6 class="mb-0 text-white font-size-sm">Instructor</h6>
                                <a href="#" class="font-size-sm text-white ms-3"><?php echo $row2['name'] ?></a>
                            </div>
                        ...
                        while ($row1 = mysqli_fetch_assoc($result1)){
                            ...
                            ?> 
                            <div class="mb-2 d-flex align-items-center">
                                <h6 class="mb-0 text-white font-size-sm">Categories</h6>
                                <a href="#" class="font-size-sm text-white ms-3"><?php echo $row1['category'] ?></a>
                            </div>
                                <?php } ?>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                            ...
                            <span><?php  echo $row['lectures']; ?></span>
                        </li>
                        ...
                        <li class="list-group-item d-flex align-items-center py-3 text-white bg-transparent border-white-10">
                            ...
                            <h6 class="mb-0 ms-3 me-auto text-white">Deadline</h6>
                ...
                <div class="col-lg-6">
                    <a href="#" class="d-block sk-thumbnail img-ratio-1 rounded mb-5">
                        
                        <img class="rounded shadow-light-lg" src="assets/img/uploadedImages/<?php echo $row['image']?>" alt="...">
                    </a>

                    <div class="d-flex align-items-center mb-2">
                        <ins class="h2 mb-0 text-white"><?php echo $row['price']; ?></ins>
                    ...
                    <div class="d-md-flex">
                        <a href="addmission-form.php?courseId=<?php echo $row['id']; ?>" class="btn btn-orange btn-wide mb-4 mb-md-0 ms-md-3 flex-grow-1">ENROLL NOW</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row pt-8">
            <div class="col-lg-8 mb-6 mb-lg-">
                <div class="mb-8">
                    <h3 class="">Course Description</h3>
                    <p class="mb-6 line-height-md"><?php echo $row['detail']; ?></p>
...
?>
                    <div class="d-flex align-items-center mb-6">
                        <div class="d-inline-block rounded-circle border me-6 p-2">
                            <div class="avatar avatar-size-120">
                                <img src="assets/img/uploadedImages/<?php echo $row2['img']; ?>" alt="..." class="avatar-img rounded-circle">
                            </div>
                        </div>
                        <div class="media-body">
                            <h4 class="mb-0"><?php echo $row2['name']; ?></h4>
                            <span><?php echo $row2['expertise']; ?></span>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <!-- SIDEBAR FILTER
                ================================================== -->
                <div class="d-none rounded border p-2 shadow mb-6">
                ...
                <div class="d-block">
                    <div class="border rounded px-6 px-lg-5 px-xl-6 pt-5 shadow">
                        ...
                        <ul class="list-unstyled mb-0">
                            <?php 
                                 $sql4 = "SELECT * FROM `course` limit 4";
                                 $result4 = mysqli_query($conn, $sql4);
                                 while ($row4 = mysqli_fetch_assoc($result4)){
                            ?>
                            <li class="media mb-6 d-flex">
                                <a href="course-detail.php?id=<?php echo $row4['id']; ?>" class="w-100p d-block me-5">
                                    <img src="assets/img/uploadedImages/<?php echo $row4['image']; ?>" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="course-detail.php?id=<?php echo $row4['id']; ?>" class="d-block">
                                        <h6 class="line-clamp-2 mb-3"><?php echo $row4['title']; ?></h6>
                                    </a>
                                    <!-- <del class="font-size-sm me-2"></del> -->
                                    <ins class="h6 mb-0 ">Rs.<?php echo $row4['price']; ?></ins> <br>
                                    <ins class="h6 mb-0 ">Discount: <?php echo $row4['discount']; ?>%</ins>
                                </div>
                            </li>
